...
monitor.config(function ($httpProvider, $stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        //水油监控
        .state('monitor-web.wateroil', {
            url: '/wateroil',
            templateUrl: root + 'module/wateroil/wateroil.html' + version,
            controller: 'wateroilCtrl',
            title: "水油监控",
            resolve: {
                loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: "水油监控",
                        files: [
                            root + "module/wateroil/wateroilCtrl.js" + version,
                            root + "module/wateroil/wateroil.css" + version,
                        ]
                    })
                }]
            }
        ...
        //油品管理
		.state('monitor-web.oilManage', {
		    url: '/oilManage',
		    templateUrl: root + 'module/oilManage/oilManage.html' + version,
		    controller: 'oilManageCtrl',
		    title: "油品管理",
		    resolve: {
		        loadMyCtrl: ['$ocLazyLoad', function($ocLazyLoad) {
		            return $ocLazyLoad.load({
		                name: "油品管理",
		                files: [
		                    root + "module/oilManage/oilManageCtrl.js" + version,
		                    root + "module/oilManage/oilManage.css" + version,
		                ]
		            })
		        }]
		    }
        ...
        //轧制状态监控
        .state('monitor-web.rollstate', {
            url: '/rollstate',
            templateUrl: root + 'module/rollstate/rollstate.html' + version,
            controller: 'rollstateCtrl',
            title: "轧制状态监控",
            resolve: {
                loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: "轧制状态监控",
                        files: [
                            root + "module/rollstate/rollstateCtrl.js" + version,
                            root + "module/rollstate/rollstate.css" + version,
                        ]
                    })
                }]
            }
        ...
        //冷却水监控
        .state('monitor-web.cool', {
            url: '/cool',
            templateUrl: root + 'module/cool/cool.html' + version,
            controller: 'coolCtrl',
            title: "轧制状态监控",
            resolve: {
                loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: "轧制状态监控",
                        files: [
                            root + "module/cool/coolCtrl.js" + version,
                            root + "module/cool/cool.css" + version,
                        ]
                    })
                }]
            }
        ...
        //轧制力分析
        .state('monitor-web.force', {
            url: '/force',
            templateUrl: root + 'module/force/forceManage.html' + version,
            controller: 'forceManageCtrl',
            title: "轧制力分析",
            resolve: {
                loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: "轧制力分析",
                        files: [
                            root + "module/force/forceManageCtrl.js" + version,
                            root + "module/force/forceManage.css" + version,
                        ]
                    })
                }]
            }
        ...
        //表面分析
        .state('monitor-web.surface', {
            url: '/surface',
            templateUrl: root + 'module/surface/surfaceManage.html' + version,
            controller: 'surfaceManageCtrl',
            title: "表面分析",
            resolve: {
                loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: "表面分析",
                        files: [
                            root + "module/surface/surfaceManageCtrl.js" + version,
                            root + "module/surface/surfaceManage.css" + version,
                        ]
                    })
                }]
            }
        ...
        //轧辊信息管理
		.state('monitor-web.inforManage', {
		    url: '/inforManage',
		    templateUrl: root + 'module/infor/inforManage.html' + version,
		    ...
		    resolve: {
		        loadMyCtrl: ['$ocLazyLoad', function($ocLazyLoad) {
		            return $ocLazyLoad.load({
		                name: "信息",
		                files: [
		                    root + "module/infor/inforManageCtrl.js" + version,
		                    root + "module/infor/inforManage.css" + version,
		                ]
		            })
		        }]
		    }
		...
		//上下限管理
		.state('monitor-web.updownManage', {
		    url: '/updownManage',
		    templateUrl: root + 'module/updown/updownManage.html' + version,
		    controller: 'updownManageCtrl',
		    title: "上下线",
		    resolve: {
		        loadMyCtrl: ['$ocLazyLoad', function($ocLazyLoad) {
		            return $ocLazyLoad.load({
		                name: "上下线",
		                files: [
		                    root + "module/updown/updownManageCtrl.js" + version,
		                    root + "module/updown/updownManage.css" + version,
		                ]
		            })
		        }]
		    }
		...
		.state('monitor-web.csp', {
            url: '/csp',
            templateUrl: root + 'page/csp/csp.html' + version,
            controller: 'cspCtrl',
            title: "csp",
            resolve: {
                loadMyCtrl: ['$ocLazyLoad', function ($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: "csp",
                        files: [
                            root + "page/csp/cspCtrl.js" + version,
                            root + "page/csp/csp.css" + version,
                        ]
                    })
                }]
            }
